...
if __name__ == "__main__":
    csv_path = "../results/combine_CP_rnn_layers_1_hidden_16_input_489_10_100_120.csv"
    saving_name = "combine_CP_10_100_120"
    saving_path = "../results/png/10"
